...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Modelado jerarquico Previo #5 Garces Hernandez Luis Angel", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//modelTemp = model = glm::translate(model, glm::vec3(1.5f, 0.0f, 0.0f)); //Recorrido del pivote 1.5
		//model = glm::scale(model, glm::vec3(3.0f, 1.0f, 1.0f)); // tamaño de la caja
		...
		//Model Antebrazo Grande
		model = glm::translate(modelTemp, glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(codo), glm::vec3(0.0f, 1.0f, 0.0f));
		modelTemp = model = glm::translate(model, glm::vec3(1.75f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(3.5f, 1.2f, 1.2f));
		color = glm::vec3(1.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		//Model Palma Grande
		model = glm::translate(modelTemp, glm::vec3(1.75f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(muneca), glm::vec3(1.0f, 0.0, 0.0f));
		...
		//Model Dedo1 A
		model = glm::translate(modelTemp, glm::vec3(0.5f, 0.35f, 0.375f));
		model = glm::rotate(model, glm::radians(dedo1), glm::vec3(0.0f, 0.0, 1.0f));
		modelTemp = model = glm::translate(model, glm::vec3(0.5f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.3f, 0.25f));
		color = glm::vec3(0.0f, 1.0f, 1.0f);
